...
React's useRouteMatch is used when creating a route and demands that the URL match the input exactly including the exact, strict, and sensitive options.

2. How would you explain form validation to someone who has never programmed before?

Form validation simply makes sure that certain fields are entered before you can continue, and if the field is not filled out then an error or notification of a sort is flagged and brings the user's attentionto what they failed to do. Several people have filled out forms on line and have probably gotten a message that their password is not long enough or that the name and email fields are required, this is done by form validation. 

3. In 1-2 sentences, define end to end testing. 

In my own words, end-to-end testing is when you use a piece of testing software to make use that a form is fully functional, although the limits do not end at only testing forms. End-to-end testing allows developers to figure out if their piece is functioning by simulating what a user would do when they come to the app.
